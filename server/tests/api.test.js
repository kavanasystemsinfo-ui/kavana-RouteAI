...
test('emailService construye HTML de bienvenida con enlaces de descarga', async () => {
  ...
  const html = buildWelcomeHtml({
    name: 'Pepe', pin: '4321',
    appUrl: 'https://routeai.kavanasystems.com/app',
    apkUrl: 'https://routeai.kavanasystems.com/download/routeai.apk',
    downloadUrl: 'https://routeai.kavanasystems.com/download'
  });
