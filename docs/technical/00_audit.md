# AUDITORIA TECNICA PROFESIONAL — KAVANA ROUTE AI
...
KAVANA Route AI es una aplicacion de gestion de logistica de campo disenada para
...
- Marca unificada: KAVANA Logistics -> KAVANA ROUTE AI (reorientado a reparto general).
...
KAVANA ROUTE AI es la division logistica de Kavana Systems disenada para
...
5. CI: ver pestaña Actions en GitHub -> workflow "CI - KAVANA Route AI"
