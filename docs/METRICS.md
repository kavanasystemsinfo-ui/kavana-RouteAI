...
| **Tests** | 75 (72 server + 3 client) | JWT, autorización/ownership, API REST, OCR, POD (PDF), optimización de rutas 2-opt, migraciones SQL, fail-fast de BD, panel de administración |
| **Commits** | +70 |
